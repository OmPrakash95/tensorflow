...
#ifndef TENSORFLOW_KERNELS_MAXMARGIN_OP_H_
#define TENSORFLOW_KERNELS_MAXMARGIN_OP_H_
...
struct SoftmaxMaxMarginFunctor {
...
#endif  // TENSORFLOW_KERNELS_MAXMARGIN_OP_H_
